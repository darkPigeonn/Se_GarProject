        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                  <li class="nav-item" role="presentation"><a class="navbar-brand" href="#page-top">Beranda</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler navbar-toggler-right" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false"
                aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
                    ...
                    <li class="nav-item"><a class="nav-link" href="#"><img src="<?php echo base_url ('assets/induko/img/search_icon.png')?>" alt="#" /></a></li>
                </ul>
            </div>
        </div>
    </nav>
    <header class="masthead" style="background-image:url(<?php echo base_url('assets/adminBaru/img/sgar-1.jpg')?>);">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in"><span>SELAMAT DATANG!</span></div>
                <h1><span>Sistem Informasi Akademik Seminari Garum</span></h1>
        </div>
    </header>
                ...
                <div class="col-lg-12">
                    <ul class="list-group timeline">
                        ...
                        <li class="list-group-item timeline-inverted">
                            <div class="timeline-image"><img class="rounded-circle img-fluid" src="<?php echo base_url('assets/induko/img/about/2.jpg')?>"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>March 2011</h4>
                        ...
                        <li class="list-group-item">
                            <div class="timeline-image"><img class="rounded-circle img-fluid" src="<?php echo base_url('assets/induko/img/about/3.jpg')?>"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>December 2012</h4>
                        ...
                        <li class="list-group-item timeline-inverted">
                            <div class="timeline-image"><img class="rounded-circle img-fluid" src="<?php echo base_url('assets/induko/img/about/4.jpg')?>"></div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>July 2014</h4>
