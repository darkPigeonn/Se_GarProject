    ...
    <header class="masthead" style="background-image:url(<?php echo base_url('assets/adminBaru/img/sgar-1.jpg')?>);">
        <div class="container">
            <div class="intro-text">
                ...
                <h4>Seminari Menengah  St. Vincentius A Paulo<br>Jl. Merdeka Timur 4-6 Garum, Blitar</h4>
              <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" role="button" href="#tentang">Tell me more</a>
           </div>
       </div>
    </header>
