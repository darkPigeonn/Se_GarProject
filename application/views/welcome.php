...
<body id="page-top" style="background-image: url(<?php echo base_url('assets/adminBaru/img/sgar-3.jpg')?>);background-size: cover;">
    ...
    <!-- End: Map Clean -->
    <footer style="height: 245px;"></footer>
    <div class="row text-center justify-content-center align-items-center">
        <div class="col text-center" style="height: 65px;"><strong class="text-center text-dark bg-light shadow-lg" style="background-position: center;font-family: Lora, serif;font-size: 37px;filter: blur(0px) brightness(100%) hue-rotate(0deg);">SISTEM INFORMASI AKADEMIK SEMINARI GARUM</strong></div>
    </div>
    <div class="row justify-content-center align-items-center" style="height: 79px;">
